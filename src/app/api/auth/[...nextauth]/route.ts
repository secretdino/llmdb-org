...
// Fully commented custom interfaces to satisfy typescript-eslint no-explicit-any rules
...
const authOptions: NextAuthOptions = {
  ...
  providers: [
    ...
    // GitHub OAuth — dev fallbacks are harmless (won't authenticate) but
    // production is guarded by the startup check above.
    GithubProvider({
  ...
  // JWT signing secret — production is guarded by the startup check above.
